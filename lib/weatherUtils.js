 ...
 */
export function getRequestURL(x, y) {
...
function getNearPredictionTime() {
    ...
    const timeSlots = ['0200', '0500', '0800', '1100', '1400', '1700', '2000', '2300'];
  
    let nearTime = timeSlots[Math.floor(hours / 3)];
